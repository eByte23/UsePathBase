...
namespace Microsoft.AspNetCore.Builder.Extensions
{
    ...
    public class UsePathBaseMiddleware
    {
        ...
        public UsePathBaseMiddleware(RequestDelegate next, PathString pathBase, bool isOptional)
        {
            if (next == null)
            {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            if (!_pathBase.HasValue)
            {
                ...
                throw new ArgumentException($"{nameof(_pathBase)} cannot be null or empty.");
            }
